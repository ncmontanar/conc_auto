...
<!--                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="customerNameId" name="customerNameId" placeholder="customerName">
                                    ...
                                    <div class="form-group">
                                      ...
                                      <input type="float" class="form-control" id="country" name="country" placeholder="country">
                                    </div>
