<%-- 
    Document   : index
    Created on : 12 sept. 2023, 21:51:12
    Author     : CamiloM
--%>
...
<!--<head>
    ...
    <title>Concession AutoFuture</title>
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="buttons.html">Charger unité</a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseClts" class="collapse" aria-labelledby="headingRh" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="utilities-color.html">Consulter Base Clients</a>
                        <a class="collapse-item" href="utilities-border.html">Ajouter nouveau client</a>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-6">
                        <h2 class="h3 mb-0 text-gray-800">Stocks</h2>  
                    </div>
                    ...
                    <div class="row">
                        ...
                        <!-- Earnings (Monthly) Tasks x3 Card Example -->
<!--                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-info shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Tasks x3
                                            </div>
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
...
<!--                        <div class="col-xl-3 col-md-6 mb-4">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-6">
                        <h2 class="h3 mb-0 text-gray-800">Ressources Humaines</h2>  
                    </div>
...
<!--                        <div class="col-xl-4 col-lg-5">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-6">
                        <h2 class="h3 mb-0 text-gray-800">Clients</h2>  
                    </div>
