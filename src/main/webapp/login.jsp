<%-- 
    Document   : login.jsp
    Created on : 4 oct. 2023, 11:14:39
    Author     : a895279
--%>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-5">  
                                <div class="p-5">
                                    ...
                                    <!-- ici commence le formaulaire login-->
                                    <form class="user" action="SvLogin" method="POST"> <!-- SvLogin aà creer -->
                                        
                                        <div class="form-group">
                                            <input type="email" class="form-control form-control-user"
                                                id="EmailLogId" name="EmailLog" 
                                                placeholder="Votre Adresse Electronique ...">
                                        </div>
                                        
                                        <div class="form-group">
                                            <input type="password" class="form-control form-control-user"
                                                id="PasswordLogId" name="PasswordLog" placeholder="Mot de Passe">
                                        </div>
                                        <!-- ca va devenir un buton  -->
